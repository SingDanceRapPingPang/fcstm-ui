...
class State:
    ...
    def __init__(self, name: str, transitions: Optional[List[Dict[str, str]]] = None,
                 ...
                 force_transitions: Optional[List[Dict[str, str]]] = None,
                 extra_name: Optional[str] = None, is_pseudo: bool = False):
        self.name = name
        ...
        self.force_transitions = force_transitions if force_transitions is not None else []
    ...
    def __repr__(self):
        ...
        return (
            f"State(name={self.name}, extra_name={self.extra_name}, is_pseudo={self.is_pseudo}, "
            f"events={self.events}, transitions={self.transitions}, force_transitions={self.force_transitions}, "
            f"lifecycle={self.lifecycle}, parent={parent_name}, children={children_names})"
        )

    def display_name(self) -> str:
        prefix = "pseudo " if self.is_pseudo else ""
        suffix = f" ({self.extra_name})" if self.extra_name else ""
